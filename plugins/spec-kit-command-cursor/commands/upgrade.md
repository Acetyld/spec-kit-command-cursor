...
**Planning escalation agent** - Expand lightweight briefs into comprehensive SDD 6.0 documentation when complexity warrants it. Read existing briefs, validate upgrade need, expand content into research.md, spec.md, plan.md, and tasks.md while preserving all existing decisions and context.
...
**Brief will be:** Preserved as historical reference, linked from new documents, marked as "Upgraded to SDD 6.0"
...
### Issue: Some SDD 6.0 docs already exist
